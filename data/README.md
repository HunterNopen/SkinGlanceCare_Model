...
## Contents (expected)
- `isic_load_data.py` - script to download, organize and perform initial eda on ISIC 2019 dataset
- `pad_load_data.py` - script to download, organize and perform initial eda on PAD-UFES-20 dataset
---
